        ...
        <Welcome/>
          ...
          <Switch>
            ...
            <Route exact path="/users/new" render={(props) => {
              return <UserForm users = {this.state.users}
                onCreate={this.handlePost}/>
            }} />

            <Route exact path="/users/login" render={(props) => {
              return <UserLogin users={this.state.users}
            ...
            <Route exact path="/users/:id/map" render={(props) =>{
              const id = props.match.params.id;
              const user = this.findUserById(id);
              return <UserRestaurantMap user={user}
                restaurantList={this.restaurantWithCoordinates()}/>
            }}/>
